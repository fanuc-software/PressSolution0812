...
namespace PressHmi.Model
{
    public class ParaAutoAirSourceInfoDto : ViewModelBase
    {
        ...
        private double m_Enable_3;
        public double Enable_3
        {
            get { return m_Enable_3; }
            set
            {
                if (m_Enable_3 != value)
                {
                    m_Enable_3 = value;
                    RaisePropertyChanged(() => Enable_3);
                }
            }
        }
        ...
        private double m_Enable_4;
        public double Enable_4
        {
            get { return m_Enable_4; }
            set
            {
                if (m_Enable_4 != value)
                {
                    m_Enable_4 = value;
                    RaisePropertyChanged(() => Enable_4);
                }
            }
        }
    }
